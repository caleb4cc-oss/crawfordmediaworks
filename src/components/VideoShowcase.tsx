...
const videos = [
  ...
  { id: 5, title: 'Founder Ad', thumbnail: '/Assets/Screenshot 2025-11-03 at 18.21.13.png', embedCode: '<iframe src="https://www.youtube.com/embed/2b3BUo3xZP8?autoplay=1&mute=1&playsinline=1" frameborder="0" allow="autoplay; fullscreen; picture-in-picture" allowfullscreen style="width:100%; height:100%; display:block;"></iframe>' },
];
